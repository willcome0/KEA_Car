...
//								Value_Inductor_R = Get_Ind_V(AD_4);	// 获取右电感
//								Value_Inductor_BL = Get_Ind_V(AD_1);
//								Value_Inductor_BR = Get_Ind_V(AD_2);
...
//									/********新环***************/
//									if(   Value_Inductor_R>_Com_Huan_Value_	// 环处识别判定
////                                        &&Pitch<-22
...
//									}
////									else if(   Value_Inductor_R>_Com_Huan_Value_	// 环处识别判定
//////                                        &&Pitch<-22
////                                        &&Value_Inductor_L>_Com_Huan_Value_
////										&& Huan_Flag == 2 &&
////										(Run_Distance - temp_dis) > _Com_InHuan_Max_+1000)
////									{
////										if(1 == _Com_Huan_LR_)
////										{
////											Value_Inductor_L = Value_Inductor_L*20/10;
////										}
////										else if(0 == _Com_Huan_LR_)
////										{
////											Value_Inductor_R = Value_Inductor_R*20/10;
...
//										Value_Inductor_L + Value_Inductor_R > 1700
//									)
//									{
//										LED_Green_ON();
//										Beep_Time(100);
...
//////										((Run_Time - temp_time)*CON_PERIOD < 300 - Value_End_R/2.5) &&	//原600
//////										(Run_Distance - temp_dis) > _Com_InHuan_Min_ &&	// 识别到环后入环距离最小值
////										(Run_Distance - temp_dis) > (_Com_InHuan_Max_ + 1000) 	// 识别到环后入环距离最大值
//////										Value_Inductor_L + Value_Inductor_R > 1700
////									)
////									{
//////										LED_Green_ON();
...
////										if(1 == _Com_Huan_LR_)
////										{
////											Value_Inductor_L = Value_Inductor_L*18/10;
//////											LR_Error = -CONTROL_Huan_Add;
////										}
////										else if(0 == _Com_Huan_LR_)
////										{
////											Value_Inductor_R = Value_Inductor_R*18/10;
//////											LR_Error = CONTROL_Huan_Add;
////										}
////									}
//									else if(temp_dis != 0 && 
//											(Huan_Flag == 1 || Huan_Flag == 2 )&&
//										 ( (Run_Distance - temp_dis) > 50000 || (Run_Time - temp_time)*CON_PERIOD > 8000) )	// 标志位重置判定
//									{
//										LED_Blue_ON();
//										Beep_Time(5);
//										temp_time = 0;
