...
void Motor_Init(void)
{
    ...
    ftm_pwm_init(ftm2,ftm_ch0,12500,0);//正转
    ftm_pwm_init(ftm2,ftm_ch5,12500,0);
    
    ftm_pwm_init(ftm2,ftm_ch2,12500,0);//正转
    ftm_pwm_init(ftm2,ftm_ch3,12500,0);
